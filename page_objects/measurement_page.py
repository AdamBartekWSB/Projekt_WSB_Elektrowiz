...
class Measurement():
    ...
    def delete_measurement(self):
        ...
        generator_select.select_by_visible_text(Variables.generator_name)
        measurement_table = driver.find_element(By.ID, Measurement.measurement_table)
        measurement_existing = Variables.measurement_date in measurement_table.text
        if measurement_existing is True:
            driver.find_element(By.XPATH, Measurement.measurement_list_number_testgen).click()
